...
switch ($action) {
    ...
    * ********************************** */
    ...
    case 'updateVehicle':
        ...
        echo $invMake = filter_input(INPUT_POST, 'clientMake', FILTER_SANITIZE_STRING);
        echo $invModel = filter_input(INPUT_POST, 'clientModel', FILTER_SANITIZE_STRING);
        echo $invDescription = filter_input(INPUT_POST, 'clientDescription', FILTER_SANITIZE_STRING);
        echo $invImage = filter_input(INPUT_POST, 'clientImage', FILTER_SANITIZE_STRING);
        echo $invThumbnail = filter_input(INPUT_POST, 'clientThumbnail', FILTER_SANITIZE_STRING);
        echo $invPrice = filter_input(INPUT_POST, 'clientPrice', FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION);
        echo $invStock = filter_input(INPUT_POST, 'clientStock', FILTER_SANITIZE_NUMBER_INT);
        echo $invColor = filter_input(INPUT_POST, 'clientColor', FILTER_SANITIZE_STRING);
        ...
        echo "this MESSAGE" . $updateResult; //!! testing
        if ($updateResult) {
            echo "holy cow";
