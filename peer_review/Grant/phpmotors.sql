...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2021 at 12:39 AM
...
(2, 'Grant', 'Petersen', 'gpetersen@gmail.com', '$2y$10$/xe73EqCt4Sn/yOiytkWT.yghii.AuolvRel5vUEbqMjOAYOOadPe', '1', NULL),
(3, 'Admin', 'User', 'admin@cse340.net', '$2y$10$GIg9goAGASNWX9ixfmXPeuiEhzcUke5GfgZgNloWhHWU0I9r9grgm', '3', NULL),
(4, 'Test', 'Account', 'test@account.com', '$2y$10$R0rGsDNQra1qPhjhJG3roOtvR3XLNcGRzIenwIjLOyTA9QTjbQiUu', '2', NULL);
...
(2, 'This car takes me everywhere that I need to go', '2021-12-10 03:15:38', 13, 3),
(4, 'noone ever gets suspicious. It does not smell like flowers though...', '2021-12-10 03:22:09', 14, 3),
(5, 'Nofast, but it turns heads --AUser', '2021-12-10 18:21:23', 2, 3);
...
--
ALTER TABLE `reviews`
  ADD CONSTRAINT `clientId` FOREIGN KEY (`clientId`) REFERENCES `clients` (`clientId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `invId` FOREIGN KEY (`invId`) REFERENCES `inventory` (`invId`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
