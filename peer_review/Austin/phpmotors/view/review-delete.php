...
<h1 id="review-update-title">Delete
    <?php if(isset($entireReview['reviewId'])){ 
        ...
        <form name='reviewform' action='/phpmotors/reviews/index.php' method='post'>
            ...
            <!-- <?php echo"This is the reviewId: " .  $entireReview['reviewId'];?>
            <?php echo"This is the reviewText: " .  $entireReview['reviewText'];?> -->

            <label for='reviewText'>
            <textarea id='reviewText' name='reviewText' readonly><?php echo $entireReview['reviewText'] ?></textarea>
            </label><br>
            <input type="submit" name="submit" id="deleteReviewBtn" value="Delete Review">
            <input type="hidden" name="action" value="handle-review-delete"> <!-- direct update through controller -->
