...
// This model will contain functions for adding a new Classification and adding a new Vehicle to the database
...
function getInvItemInfo($invId){
   ...
   // Update vehicle record function
...
// a classificationId is passed to this function where ultimately, a list of matching vehicles in our inventory will be returned
...
// This function finds a vehicle in the database based on the inventory ID that it is given
